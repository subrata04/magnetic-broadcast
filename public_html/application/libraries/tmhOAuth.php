  ...
  public function reconfigure($config=array()) {
    ...
    $this->config = array_merge(
      array(
        ...
        'consumer_key'               => 'IIKoZJRWoGsYaNOjtqkjA',
        'consumer_secret'            => 'NcbpvoPXVGEAKRv53F3n2aJMphsYDy7zBB4UBL64g',
        'token'                      => '1019522304-xAoclFAsIexAe0TvanUjiIEImPiD9Ev3IHo8IsM',
        'secret'                     => 'xbGk16M8zuY12MtTlZTJao1YnMNzAMFzrWha6q9SpCA',
