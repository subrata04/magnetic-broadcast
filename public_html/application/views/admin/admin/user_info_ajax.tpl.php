...
<div id="fbcontent" class="fb_div" style="width: 600px;text-align: left;">
    ...
    <?php
        ...
        <div style="text-align: center;">
            <?php  if($m_send_data['i_user_role']!=USER_ROLE){  ?>
                <input type="button" value="Edit" name="submit" class="button" onclick="window.location.href='<?php echo admin_url().'admin/edit/'.strEncode($m_send_data['id'])?>'"> 
                <?php } ?>  
