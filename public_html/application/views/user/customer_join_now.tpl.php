<script type="text/javascript">
    <?php /* if(!empty($s_msg_captcha)){?>
        $(function(){
        $("#2nd_head").activateSlide();
        $("#2nd_acc_head").trigger('click');
        });    
    <?php } */ ?>
</script>
                    ...
                    <dl>
                        ...
                        <dd >
                            ...
                            <div class="login_form">                            
                                ...
                                <div class="blok">
                                    <span class="imp" >
                                        <?php // echo !empty($s_msg_captcha)?$s_msg_captcha:""; ?>
                                    </span>
                                </div>
                            </div>
                        </dd>
                            ...
                            <div class="login_form">
                                <div class='mycustomscroll'>
                                    ...
                                    <div class="blok">
                                        ...
                                        <input name="user_type" type="radio" value="<?php echo strEncode(PROMOTER_ROLE); ?>" id="opt1" <?php echo set_radio('user_type', strEncode(PROMOTER_ROLE)); ?> /> Promoter
                                        <input name="user_type" type="radio" value="<?php echo strEncode(PROMOTER_PRO_ROLE); ?>" id="opt2" <?php echo set_radio('user_type', strEncode(PROMOTER_PRO_ROLE)); ?> /> Promoter Pro
                                        <input name="user_type" type="radio" value="<?php echo strEncode(FREE_AFFILIATE_ROLE); ?>" id="opt3" <?php echo set_radio('user_type', strEncode(FREE_AFFILIATE_ROLE)); ?> /> Free Affiliate 
                                        <div class="clr"></div> 
                                        <div id="err_msg"></div>
                                        <input type="hidden" id='enr_fee' />
                                    </div>

                                    <div id="main_cont" style="display: none;">
                                        <div>
                                            <div class="blok_text2 show_details">Chose your product</div>
                                            <div class="clr"></div> 
                                        ...
                                        <!--***************************Start billing add********************************* -->
                                        <div>
                                            <div class="blok_text2 show_details">Your Account Info</div>
                                            <div class="clr"></div>
