    ...
    public function listing($i_page=1) {
        ...
        */
        ...
        if (in_array(ADMIN_ROLE, get_ses_data('i_roles'))) {
            ...
            $m_where = $m_where . " AND id!=".get_ses_data('i_user_id')." AND i_user_role=4";    
            $s_group_by = 'id';
            $s_order_by_name = 'id';
            $s_order_by = 'DESC';
            ...
            if($i_total_rows>0){
                ...
                if($i_last_page<$i_page){   // If no data found            
                    redirect(admin_url().'user/listing/'.$i_last_page);
                }
            }
        }else {
        ...
        $m_conf['base_url'] = admin_url().'user/listing/';
